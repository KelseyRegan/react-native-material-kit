...
class IndeterminateProgress extends Component {
  ...
  render() {
	var bufferColor = this.props.bufferColor || Progress.defaultProps.style.bufferColor;
	
    return (
      <View  // the background layer
        ref="bg"
        style={[Progress.defaultProps.style, this.props.style, {backgroundColor:bufferColor}]}
        onLayout={this._onLayout.bind(this)}
        >
